...
//go:embed http_observation.go.tmpl
var httpObservationSource string
...
func (g *Generator) Generate(ctx gen.Context) ([]gen.File, *gen.Wiring, error) {
	...
	loggerIndex := 0
	return files, &gen.Wiring{HTTPErrorLogger: &loggerIndex, Imports: []string{ctx.OutputNamespace}, Constructors: []string{path.Base(ctx.OutputNamespace) + ".NewTracingRuntime()"}, ConstructorResources: map[int][]gen.Resource{0: {gen.OptionalSQLDatabase}}, ConstructorReturnsError: map[int]bool{0: true}, ConstructorDeferCalls: map[int]string{0: "Close()"}, Middlewares: []gen.MiddlewareSpec{{ConstructorIndex: 0, WrapExpr: "%s.Route(%s)"}}, OuterMiddlewares: []gen.MiddlewareSpec{{ConstructorIndex: 0, WrapExpr: "%s.Handler(%s)"}}, GoModRequires: map[string]string{
		...
		"go.opentelemetry.io/otel": "v1.46.0", "go.opentelemetry.io/otel/trace": "v1.46.0", "go.opentelemetry.io/otel/sdk": "v1.46.0", "go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc": "v1.46.0", "google.golang.org/grpc": "v1.83.2", "github.com/felixge/httpsnoop": "v1.0.4", "go.opentelemetry.io/proto/otlp": "v1.11.0", "google.golang.org/protobuf": "v1.36.12",
	}}, nil
}
