...
The [cleanup timing review](cleanup-latency-review-20260921.md) records four
complete 100-account samples and the diagnostic observation that bounds the
delay inside Kubernetes.
